...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "created_at",
            sa.Integer(),
            server_default=sa.text("EXTRACT(epoch FROM CURRENT_TIMESTAMP)"),
            nullable=True,
        ),
        sa.Column(
            "updated_at",
        ...
        sa.Column(
            "township", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column(
            "has_vacancy", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "available_period",
        ...
        sa.Column(
            "contact_info", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column(
            "address", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column(
            "pricing", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "status", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "restrictions", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "room_info", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "coordinates", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "info_source", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "role_type", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("headcount_need", sa.Integer(), nullable=False),
        sa.Column("headcount_got", sa.Integer(), nullable=False),
        sa.Column(
            "role_status", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        ...
        sa.Column(
            "valid_pin", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("id", sa.String(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column(
            "station_type", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column(
            "status", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
    ...
    op.create_table(
        ...
        sa.Column("capacity", sa.Integer(), nullable=True),
        sa.Column(
            "waiting_time", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("id", sa.String(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "location_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column(
            "location_type",
    ...
    op.create_table(
        ...
        sa.Column(
            "cleanliness", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "opening_hours", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("id", sa.String(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column(
            "time_slots", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "available_period",
            sqlmodel.sql.sqltypes.AutoString(length=255),
        ...
        sa.Column("phone", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True),
        sa.Column(
            "gender_schedule", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("capacity", sa.Integer(), nullable=True),
        sa.Column(
            "pricing", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column(
            "info_source", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
    ...
    op.create_table(
        ...
        sa.Column(
            "coordinator", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "contact_info", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "registration_method",
            sqlmodel.sql.sqltypes.AutoString(length=255),
    ...
    op.create_table(
        ...
        sa.Column(
            "water_type", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
            "opening_hours",
            sqlmodel.sql.sqltypes.AutoString(length=255),
        ...
        sa.Column("daily_capacity", sa.Integer(), nullable=True),
        sa.Column(
            "water_quality", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("facilities", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "distance_to_disaster_area",
    ...
    op.create_table(
        ...
        sa.Column("tag", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
